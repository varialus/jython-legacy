...
public interface TextKeys {
    ...
    public static final String INSTALLATION_TYPE_PROPERTY = "INSTALLATION_TYPE_PROPERTY";
    ...
    public static final String C_INVALID_OPTION = "C_INVALID_OPTION";
    public static final String C_INVALID_TYPE = "C_INVALID_TYPE";
    public static final String C_JAVA_VERSION = "C_JAVA_VERSION";
    public static final String C_MINIMUM = "C_MINIMUM";
    public static final String C_NEED_SILENT_MODE = "C_NEED_SILENT_MODE";
    public static final String C_NEED_VALUE_FOR_OPTION = "C_NEED_VALUE_FOR_OPTION";
    ...
    public static final String C_TARGET_DIRECTORY_NOT_SPECIFIED = "C_TARGET_DIRECTORY_NOT_SPECIFIED";
