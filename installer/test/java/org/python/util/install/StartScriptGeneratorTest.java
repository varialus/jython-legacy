...
public class StartScriptGeneratorTest extends TestCase {
    ...
    public void testWindows() throws IOException {
        ...
        winBuf.append("rem Created on " + AT_DATE + " by " + System.getProperty("user.name") + ""+WIN_CR_LF);
        winBuf.append(WIN_CR_LF);
        winBuf.append("set ARGS="+WIN_CR_LF);
        winBuf.append(WIN_CR_LF);
        winBuf.append(":loop"+WIN_CR_LF);
        winBuf.append("if [%1] == [] goto end"+WIN_CR_LF);
        winBuf.append("    set ARGS=%ARGS% %1"+WIN_CR_LF);
        winBuf.append("    shift"+WIN_CR_LF);
        winBuf.append("    goto loop"+WIN_CR_LF);
        winBuf.append(":end"+WIN_CR_LF);
        winBuf.append(WIN_CR_LF);
        ...
        buf.append("\"C:\\java\\bin\\java.exe\" -Dpython.home=\"C:\\target\" -classpath \"C:\\target\\"
                + JarInstaller.JYTHON_JAR + ";%CLASSPATH%\" org.python.util.jython %ARGS%"+WIN_CR_LF);
        assertEquals(buf.toString().replaceAll(AT_DATE, new Date().toString()), _generator
