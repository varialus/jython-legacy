...
class HTMLTranslator(html4css1.HTMLTranslator):
	...
	onopenclose:function(header, index, state, isuseractivated){ //custom code to run whenever a header is opened or closed
        ...
        buffer.append('<p style="top: 25px; color:#000">Latest release - 2.5.2<br/>')
        buffer.append('<a style="color:#000" href="latest.html">View Release Notes</a><br/>')
        buffer.append('Download: <a style="color:#000" href="http://sourceforge.net/projects/jython/files/jython/2.5.2/jython_installer-2.5.2.jar/download">.jar</a>')
        buffer.append('</div>')
