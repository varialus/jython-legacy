...
if (typeof renderTwitters != 'function') (function () {
	...
	var div = node('div'), innerdiv;
	    ...
	    innerdiv.id = "twit_inner";
		   ...
		   // alert("inside")
		    ...
		    var content = image + "" + text + "<br/><br></div><div align='left' font-size='5pt;'><a style='font-size:7pt; border-bottom:1px; color:green;' href=http://www.twitter.com/" + user + ">" + user + ": " +  time.substring(4, (time.length - 6)) + "</a></div></div>";
    ...
    window.getTwitters = function (target, id, count, options) {
        ...
        ready((function(options, guid) {
            return function () {
                ...
                var url = 'http://search.twitter.com/search.json?q=' + id;
    ...
    window.getSearchTwitters = function(target, id, count, options) {
        ...
        ready((function(options, guid) {
            return function() {
                ...
                var url = 'http://search.twitter.com/search.json?callback=twitterCallback&count=20&q=' + id;
    ...
    function getTwitterData(orig) {
        ...
        for (i in orig.results) {
            data['results_' + i] = orig.results[i];
