...
public class FlowGraphGenerator extends VisitorBase<Variable>
    ...
    private Variable loadDefaults(java.util.List<expr> defaults) throws Exception {
        Variable[] vars = evalAll(defaults);
        return current.valueOperation(ValueOperation.GROUP_VARIABLES, vars);
    }

    private Variable[] loadDecorators(java.util.List<expr> decorators) throws Exception {
    ...
    private Variable eval(expr value) throws Exception {
        return value.accept(this);
    }

    private Variable eval(slice slice) throws Exception {
    ...
    private Variable[] evalAll(java.util.List<expr> values) throws Exception {
        Variable[] result = new Variable[values.size()];
        for (int i = 0; i < values.size(); i++) {
            result[i] = eval(values.get(i));
        }
        return result;
    }
    ...
    private class Assignment extends VisitorBase<Void> {
        ...
        public Void visitDict(Dict node) throws Exception {
            ...
            for (int i = 0; i < node.getInternalKeys().size(); i++) {
                Variable key = eval(node.getInternalKeys().get(i));
                Variable value = current.valueOperation(
        ...
        public Void visitAttribute(Attribute node) throws Exception {
            Variable target = eval(node.getInternalValue());
        ...
        public Void visitSubscript(Subscript node) throws Exception {
            Variable target = eval(node.getInternalValue());
            Variable slice = eval(node.getInternalSlice());
    ...
    public GeneratedCodeState<Variable> beforeClassDef(ClassDef node,
        ...
        Variable bases = current.valueOperation(ValueOperation.GROUP_VARIABLES,
                baseVars);
        return new GeneratedCodeState<Variable>(name, bases, loadClosure(scope),
                new Variable[] {});
    }
    ...
    public void afterClassDef(ClassDef node, GeneratedCodeState<Variable> state,
    ...
    public GeneratedCodeState<Variable> beforeFunctionDef(FunctionDef node,
        ...
        return new GeneratedCodeState<Variable>(name, loadClosure(scope),
                loadDefaults(node.getInternalArgs().getInternalDefaults()), decorators);
    }
    ...
    public void afterFunctionDef(FunctionDef node, GeneratedCodeState<Variable> state,
            Variable result) throws Exception {
    ...
    public GeneratedCodeState<Variable> beforeLambda(Lambda node, ScopeInformation scope)
            throws Exception {
        ...
        graph.generateCode(new ManagedSimpleCallback() {
            ...
            public void generate() throws Exception {
                current.terminate(new BlockTermination.Return(
                        node.getInternalBody().accept(compiler)));
            }
        });
        return graph.handle();
    }

    public Variable afterLambda(Lambda node, GeneratedCodeState<Variable> state,
            Variable result) throws Exception {
    ...
    public GeneratedCodeState<Variable> beforeGeneratorExp(GeneratorExp node,
            ScopeInformation scope) throws Exception {
        Variable startArg = eval(node.getInternalGenerators().get(0).getInternalIter());
        startArg = current.valueOperation(ValueOperation.GET_ITERATOR, startArg);
        return new GeneratedCodeState<Variable>(null, loadClosure(scope), startArg);
    }
            ...
            public void generate(Variable argument) throws Exception {
                ...
                traverseComprehension(node.getInternalGenerators(), iter,
                        new ManagedSimpleCallback() {
                            @Override
                            public void generate() throws Exception {
                                current.performYield(eval(node.getInternalElt()));
                            }
                        });
            }
        });
    ...
    public Variable afterGeneratorExp(GeneratorExp node,
            GeneratedCodeState<Variable> state, Variable result) throws Exception {
    ...
    private void traverseComprehension(final java.util.List<comprehension> generators,
        ...
        IterativeTraverser it = new IterativeTraverser(new TraverseBody() {
            public Variable generate(final IterativeTraverser traverser,
                ...
                if (generator.getInternalIfs() != null && !generator.getInternalIfs().isEmpty()) {
                    ...
                    iterativeTraversal(new TraverseBody() {
                        public Variable generate(IterativeTraverser traverser,
                                Variable variable) throws Exception {
                            Variable result = eval(ifs.get(traverser.index));
                    ...
                    current.performIteratorLoop(new ManagedProducerCallback() {
                        ...
                        Variable generate() throws Exception {
                            return eval(generators.get(traverser.index + 1).getInternalIter());
                        }
                    }, traverser.next(null), Generate.NOTHING);
                }
                return null;
    ...
    public Variable visitFor(final For node) throws Exception {
        current.performIteratorLoop(new ManagedProducerCallback() {
            @Override
            Variable generate() throws Exception {
                return eval(node.getInternalIter());
            }
    ...
    public Variable visitWhile(final While node) throws Exception {
        current.performBooleanLoop(new ManagedProducerCallback() {
            @Override
            Variable generate() throws Exception {
                return eval(node.getInternalTest());
            }
        }, new ManagedSimpleCallback() {
            @Override
            void generate() throws Exception {
    ...
    public Variable visitListComp(final ListComp node) throws Exception {
        ...
        Variable iterVal = eval(node.getInternalGenerators().get(0).getInternalIter());
    ...
    public Variable visitIf(final If node) throws Exception {
        current.performSelection(eval(node.getInternalTest()), new ManagedSimpleCallback() {
            @Override
            void generate() throws Exception {
                compile(node.getInternalBody());
            }
    ...
    public Variable visitIfExp(final IfExp node) throws Exception {
        return current.performSelection(eval(node.getInternalTest()),
                new ManagedProducerCallback() {
                    @Override
                    Variable generate() throws Exception {
                        return eval(node.getInternalBody());
                    }
                }, new ManagedProducerCallback() {
                    @Override
                    Variable generate() throws Exception {
                        return eval(node.getInternalOrelse());
                    }
                });
    }
    ...
    public Variable visitBoolOp(final BoolOp node) throws Exception {
        ...
        return iterativeTraversal(new TraverseBody() {
            public Variable generate(IterativeTraverser traverser,
                    Variable variable) throws Exception {
                Variable result = eval(node.getInternalValues().get(traverser.index));
    ...
    public Variable visitCompare(final Compare node) throws Exception {
        Variable left = eval(node.getInternalLeft());
        if (node.getInternalComparators().size() == 1) {
            Variable right = eval(node.getInternalComparators().get(0));
            return current.valueOperation(comparators.get(node.getInternalOps().get(0)), left,
                    right);
        } else {
            return iterativeTraversal(new TraverseBody() {
                public Variable generate(IterativeTraverser traverser,
                        Variable variable) throws Exception {
                    Variable next = eval(node.getInternalComparators().get(traverser.index));
                    Variable result = current.valueOperation(
                            comparators.get(node.getInternalOps().get(0)), traverser.state, next);
    ...
    public Variable visitAssign(Assign node) throws Exception {
        Variable value = eval(node.getInternalValue());
    ...
    public Variable visitAugAssign(AugAssign node) throws Exception {
        ...
        if (node.getInternalTarget() instanceof Name) {
            ...
            Variable lhs = eval(name);
            Variable rhs = eval(node.getInternalValue());
            ...
            Variable owner = eval(attribute.getInternalValue());
            ...
            Variable owner = eval(sub.getInternalValue());
            Variable slice = eval(sub.getInternalSlice());
    ...
    public Variable visitCall(Call node) throws Exception {
        ...
        for (int i = 0; i < node.getInternalKeywords().size(); i++) {
            ...
            Variable value = eval(node.getInternalKeywords().get(i).getInternalValue());
        ...
        Variable starargs = node.getInternalStarargs() != null ? eval(node.getInternalStarargs())
                : CodeGraph.Void();
        Variable kwargs = node.getInternalKwargs() != null ? eval(node.getInternalKwargs())
                : CodeGraph.Void();
    ...
    public Variable visitExec(Exec node) throws Exception {
        Variable body = eval(node.getInternalBody());
        Variable globals;
        Variable locals;
        if (node.getInternalGlobals() != null) {
            globals = eval(node.getInternalGlobals());
            if (node.getInternalLocals() != null) {
                locals = eval(node.getInternalLocals());
            } else {
                locals = globals;
            }
        } else {
    ...
    public Variable visitDict(Dict node) throws Exception {
        ...
        for (int i = 0; i < node.getInternalKeys().size(); i++) {
            Variable value = eval(node.getInternalValues().get(i));
    ...
    public Variable visitTuple(Tuple node) throws Exception {
        ...
        for (int i = 0; i < node.getInternalElts().size(); i++) {
            elts[i] = eval(node.getInternalElts().get(i));
        }
    ...
    public Variable visitImportFrom(ImportFrom node) throws Exception {
        ...
        if (flags.isFlagSet(CodeFlag.CO_FUTURE_ABSOLUTE_IMPORT)) {
            module = current.valueOperation(ValueOperation.IMPORT_ABSOLUTE,
                    moduleName, graph.getConstant(node.getInternalLevel()), names);
        } else {
        ...
        for (int i = 0; i < node.getInternalNames().size(); i++) {
            Variable child = current.valueOperation(ValueOperation.IMPORT_FROM,
                    module, nameVars[i]);
            String name = node.getInternalNames().get(i).getInternalAsname() != null ? node.getInternalNames().get(i).getInternalAsname()
    ...
    public Variable visitPrint(Print node) throws Exception {
        ...
        if (node.getInternalDest() != null) {
            ...
            variables[i++] = eval(node.getInternalDest());
        ...
        for (int j = 0; j < node.getInternalValues().size(); j++) {
            variables[i++] = eval(node.getInternalValues().get(j));
        }
    ...
    public Variable visitAssert(Assert node) throws Exception {
        Variable test = eval(node.getInternalTest());
        Variable msg = eval(node.getInternalMsg());
    ...
    public Variable visitExpr(Expr node) throws Exception {
        Variable result = eval(node.getInternalValue());
        if (printResult) {
    ...
    public Variable visitBinOp(BinOp node) throws Exception {
        Variable left = eval(node.getInternalLeft());
        Variable right = eval(node.getInternalRight());
        ValueOperation op;
        if (node.getInternalOp() == operatorType.Div) {
    ...
    public Variable visitExtSlice(ExtSlice node) throws Exception {
        ...
        for (int i = 0; i < node.getInternalDims().size(); i++) {
            dims[i] = eval(node.getInternalDims().get(i));
        }
    ...
    public Variable visitIndex(Index node) throws Exception {
        return eval(node.getInternalValue());
    }

    @Override
    public Variable visitSlice(Slice node) throws Exception {
        Variable lower = node.getInternalLower() != null ? eval(node.getInternalLower())
                : CodeGraph.None();
        Variable upper = node.getInternalUpper() != null ? eval(node.getInternalUpper())
                : CodeGraph.None();
        Variable step = node.getInternalStep() != null ? eval(node.getInternalStep()) : CodeGraph.None();
    ...
    public Variable visitRaise(Raise node) throws Exception {
        if (node.getInternalType() == null) {
            ...
            Variable type = eval(node.getInternalType());
            Variable instance = node.getInternalInst() != null ? eval(node.getInternalInst())
                    : CodeGraph.Void();
            Variable traceback = node.getInternalTback() != null ? eval(node.getInternalTback())
                    : CodeGraph.Void();
    ...
    public Variable visitReturn(Return node) throws Exception {
        current.terminate(new BlockTermination.Return(eval(node.getInternalValue())));
        return null;
    }
        ...
        final TraverseBody handlers = new TraverseBody() {
            public Variable generate(IterativeTraverser traverser,
                ...
                if (traverser.index == node.getInternalHandlers().size()) {
                    ...
                    current.terminate(new BlockTermination.Raise(exception));
                    return null;
                } else if (((ExceptHandler)node.getInternalHandlers().get(traverser.index)).getInternalType() == null) {
                    // Matches anything
                    ExceptHandler handler = (ExceptHandler)node.getInternalHandlers().get(traverser.index);
                    ...
                    final ExceptHandler handler = (ExceptHandler)node.getInternalHandlers().get(traverser.index);
                    Variable match;
                    if (handler.getInternalType() instanceof Tuple) {
                        ...
                        match = iterativeTraversal(new TraverseBody() {
                            public Variable generate(
                                    ...
                                    Variable variable) throws Exception {
                                Variable type = eval(tuple.getInternalElts().get(traverser.index));
                        ...
                        Variable type = eval(handler.getInternalType());
                                ...
                                Variable generate() throws Exception {
                                    if (handler.getInternalName() != null) {
                                        Variable value = current.valueOperation(
                                                ...
                                                exception);
                                        handler.getInternalName().accept(new Assignment(
                                                value));
                                    }
                                    compile(handler.getInternalBody());
                                    return null;
    ...
    public Variable visitUnaryOp(UnaryOp node) throws Exception {
        Variable operand = eval(node.getInternalOperand());
        return current.valueOperation(unaryOperators.get(node.getInternalOp()), operand);
    }

    @Override
    public Variable visitWith(final With node) throws Exception {
        Variable context = eval(node.getInternalContext_expr());
    ...
    public Variable visitYield(Yield node) throws Exception {
        return current.performYield(eval(node.getInternalValue()));
    }
